...
arslogistic: src/arslogistic/utilR.h src/arslogistic/arms.c src/arslogistic/arsspline.c src/RLFM-ars-logistic/C/util.c src/RLFM-ars-logistic/C/MCEM_EStep_logistic.c
	R CMD SHLIB src/arslogistic/arms.c src/arslogistic/arsspline.c src/RLFM-ars-logistic/C/util.c src/RLFM-ars-logistic/C/MCEM_EStep_logistic.c -o lib/arslogistic.so
